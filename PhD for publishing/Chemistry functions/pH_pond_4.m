...
% This function aims at calculating the pH of a solution depending on total
% inorganic carbon, total inorganic phosphorous, total ammoniacal N, inert
% ions balance, and pond temperature.
% This calculation is based on the methodology outlined 
% in the thesis Chambonnniere, 2019 manuscript, and was intended for
% application to algal ponds at pH 7 - 11.5.
...
% calculation of temperature dependent equilibrium constants
...
% Calcualtion of the coefficient of the polynomial to solve for the
% determination of pH
