...
% This function aims at calculating the equilibrium constant for the ionic product of water H2O <=> OH- + H+ -
% This equilibrium constant is valid for activities calculated in mol/L
% The calucaltion was developped from data in Metcalf and Eddy using linear
% interpolation to obtain a value at any temperature.
% This equilibrium constant is valid for activities calculated in mol/L
