...
% Another formula was found still in Metcalf and Eddy in which H is
% calculated as log10(H) = -A/T + B
...
% if  T < 283.15
%     H = (1072 - 793)/10*(T - 273.15) + 793;
%     CO2_sat = 1/(1.50*10^(-6))*1/H*400*10^(-6);
% else
%     if (T >= 283.15) && (T < 293.15)
%         H = (1420 - 1072)/10*(T - 283.15) + 1072;
%         CO2_sat = 1/(1.50*10^(-6))*1/H*400*10^(-6);
%     else
%         if (T >= 293.15) && (T < 303.15)
%             H = (1846 - 1420)/10*(T - 293.15) + 1420;
%             CO2_sat = 1/(1.50*10^(-6))*1/H*400*10^(-6);
%         else
%             if (T >= 303.15) && (T < 313.15)
%                 H = (2360 - 1846)/10*(T - 303.15) + 1846;
%                 CO2_sat = 1/(1.50*10^(-6))*1/H*400*10^(-6);
%             else
%                 if (T >= 313.15) && (T < 323.15)
%                     H = (2971 - 2360)/10*(T - 313.15) + 2360;
%                     CO2_sat = 1/(1.50*10^(-6))*1/H*400*10^(-6);
%                 end
%             end
%         end
