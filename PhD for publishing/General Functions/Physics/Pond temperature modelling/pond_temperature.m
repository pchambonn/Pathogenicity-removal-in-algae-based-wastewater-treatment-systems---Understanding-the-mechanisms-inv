...
% qi : inflow rate (m3/s)
% str : string of character which enables to use a data file from Quinn
% modelling
...
%% Interpolation
% As JQ time step for the data is of one hour, I had trouble when
% implementing the modelling. Assuming the problem comes from the step, I
% decided to linearly interpolate the inputs with a length multiplication
% factor of p_t (also meaning the time step is divided by p_t)
